...
namespace TestMKL.Benchmarks
{
    static class SparseMatrices
    {
        ...
        public static double[,] matrixInvertible = new double[,] {
        ...
        public static double[] x = new double[] { 7.5025, 9.8100, 2.3352, 0.9623, 3.8458, 5.0027, 5.7026, 9.7663, 4.9286, 4.0088 };
        public static double[] matrixPosdef_x = new double[] { 5.7600, 6.7250, 0.8889, 0.2731, 1.0588, 1.7886, 0.9570, 1.3229, 1.2075, -0.9106 };
        public static double[] matrixInvertible_x = new double[] { 10.1397, 5.6358, 12.1045, 4.7252, 12.7401, 10.9671, 9.1738, 7.7304, 6.6591, 11.6228 };
        public static double[] matrixSingular_x = new double[] { 12.1496, 1.6742, 12.7606, 5.2371, 17.2221, 4.7099, 14.6284, 7.5221, 10.5766, 5.9025 };
    }
}
